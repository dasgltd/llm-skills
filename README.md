...
| [infinity-api-guidance](./skills/infinity-api-guidance/) | Best practices, architectural patterns, and known quirks/limitations for integrating with the Infinity (StartInfinity) project management API — auth/versioning traps, value upserts, real webhook payload shapes, automation-cascade dedupe, comments, time tracking, and n8n patterns. |
